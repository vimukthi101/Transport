...
<form id="form1" name="form1" method="post" action="../../../../Users/Admin/Downloads/vehicle/vehicle/do?MOD=MTN&amp;ACT=AddFuel">
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <td><label>
		...
		<option value="<%=(String)al1.get(i)%>"></option>
    ...
    <tr>
      ...
      <a href="javascript: void(0);" onmouseover="if (timeoutId) clearTimeout(timeoutId);window.status='Show Calendar';return true;" onmouseout="if (timeoutDelay) calendarTimeout();window.status='';" onclick="g_Calendar.show(event,'form1.fdate',true,'yyyy-mm-dd'); return false;"><img src="../../../../Users/Admin/Downloads/vehicle/vehicle/include/calendar.gif" alt="" name="imgCalendar" width="34" height="21" border="0" id="imgCalendar"></a></label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
