...
<form id="form1" name="form1" method="post" action="../../../../Users/Admin/Downloads/vehicle/vehicle/do?MOD=MTN&amp;ACT=AddOil">
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <a href="javascript: void(0);" onmouseover="if (timeoutId) clearTimeout(timeoutId);window.status='Show Calendar';return true;" onmouseout="if (timeoutDelay) calendarTimeout();window.status='';" onclick="g_Calendar.show(event,'form1.doe',true,'yyyy-mm-dd'); return false;"><img src="../../../../Users/Admin/Downloads/vehicle/vehicle/include/calendar.gif" alt="" name="imgCalendar" width="34" height="21" border="0" id="imgCalendar"></a></label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
        <input name="Submit" type="submit" class="redButton" onclick="MM_validateForm('VehicleName','','R','DriverName','','R','Cost','','R','Odometer','','R');return document.MM_returnValue" value="Add Detail" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
  </table>
