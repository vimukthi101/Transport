...
<form id="form1" name="form1" method="post" action="Controller/plantVisitController.php" enctype="multipart/form-data">
    <tr>
      <th colspan="5" scope="col"><div class="header">
        <div align="left">Book A Vehicle For Plant Visits</div>
      </div></th>
    </tr>
    <tr>
      <td width="15%">&nbsp;</td>
    ...
    <tr>
      ...
      <td>:</td>
      <td><label>
        <input name="datePick" type="datetime-local" id="datePick" required />
      </label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <td colspan="5">
	  ...
	  if(isset($_GET['message'])){
		  ...
		  if ($massege=="1") {
			  ...
			  echo 'Booking should be 6 hours greater than from the current time';
		  }
		  else if ($massege=="4") {
