...
<table width="100%" align="center"  style="border:#D22929 solid 2px;padding:10px;" border="0">
  <tr>
    ...
    <th bgcolor="#D22929" scope="col"><span class="style10">Driver Number</span></th>
    <th bgcolor="#D22929" scope="col"><span class="style10">Vehicle Number</span></th>
    <th bgcolor="#D22929" scope="col"><span class="style10">Arrange</span></th>
  </tr>
<?php
	...
	while($row= mysqli_fetch_array($result)){
		...
		$id = $row['id'];
			echo '<tr style="height:30px; padding:4px;">
					...
					<form action="controller/arrange.php" method="post">
					<td><div align="center"><input type="text" name="name" id="name"/><input hidden type="text" name="id" id="id" value="'.$id.'"/></div></td>
					<td><div align="center"><input type="text" name="mobile" id="mobile"/></div></td>
					<td><div align="center"><input type="text" name="vno" id="vno"/></div></td>
					<td><div align="center"><input type="submit" value="Arranged"/></div></td>
					</form>
				</tr>';	
	}
} else {
	...
	while($row= mysqli_fetch_array($result)){
		...
		$id = $row['id'];
			echo '<tr style="height:30px; padding:4px;">
					...
					<td><div align="center">'.$type.'</div></td>
					<form action="controller/arrangePlant.php" method="post">
					<td><div align="center"><input type="text" name="name" id="name"/><input hidden type="text" name="id" id="id" value="'.$id.'"/></div></td>
					<td><div align="center"><input type="text" name="mobile" id="mobile"/></div></td>
					<td><div align="center"><input type="text" name="vno" id="vno"/></div></td>
					<td><div align="center"><input type="submit" value="Arranged"/></div></td>
	...
	while($row= mysqli_fetch_array($result)){
		...
		$id = $row['id'];
			echo '<tr style="height:30px; padding:4px;">
					...
					<td><div align="center">'.$date.'</div></td>
					<td><div align="center">'.$reason.'</div></td>
					<form action="controller/arrangeDelivery.php" method="post">
					<td><div align="center"><input type="text" name="name" id="name"/><input hidden type="text" name="id" id="id" value="'.$id.'"/></div></td>
					<td><div align="center"><input type="text" name="mobile" id="mobile"/></div></td>
					<td><div align="center"><input type="text" name="vno" id="vno"/></div></td>
					<td><div align="center"><input type="submit" value="Arranged"/></div></td>
