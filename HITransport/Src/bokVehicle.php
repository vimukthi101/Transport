...
<form id="form1" name="form1" method="post" action="../../../../Users/Admin/Downloads/vehicle/vehicle/do?MOD=BOK&amp;ACT=doBok">
  <table width="90%" align="center" style="border:#D22929 solid 2px;padding:5px;" border="0" >
    ...
    <tr>
      ...
      <td><strong>Rupees Per Kilometer : </strong></td>
    ...
    <tr>
      <td width="36%"><strong>Fuel Type:</strong></td>
      <td width="43%"><strong>Cost : </strong>&nbsp;Rs.</td>
    </tr>
    <tr>
      <td colspan="2"><strong>Vehicle Type: </strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <a href="javascript: void(0);" onMouseOver="if (timeoutId) clearTimeout(timeoutId);window.status='Show Calendar';return true;" onMouseOut="if (timeoutDelay) calendarTimeout();window.status='';" onClick="g_Calendar.show(event,'form1.sdate',true,'yyyy-mm-dd'); return false;"><img src="../../../../Users/Admin/Downloads/vehicle/vehicle/include/calendar.gif" name="imgCalendar" width="25" height="21" border="0" alt="" ></a></label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <a href="javascript: void(0);" onMouseOver="if (timeoutId) clearTimeout(timeoutId);window.status='Show Calendar';return true;" onMouseOut="if (timeoutDelay) calendarTimeout();window.status='';" onClick="g_Calendar.show(event,'form1.edate',true,'yyyy-mm-dd'); return false;"><img src="../../../../Users/Admin/Downloads/vehicle/vehicle/include/calendar.gif" name="imgCalendar" width="25" height="21" border="0" alt="" ></a></label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
