...
html,body{
    ...
    font-size: small;
    color:#FA0;
    background-image: url(../../../../Users/Admin/Downloads/vehicle/vehicle/images/pattern.gif);
}
.style1 {
	font-size: 16px;
	font-weight: bold;
  ...
  <tr>
    ...
    <td><form id="form1" name="form1" method="post" action="">
      <table width="100%" border="0" align="center">
        ...
        <tr>
          <td width="46%" rowspan="8"><img src="../../../../Users/Admin/Downloads/vehicle/vehicle/images/car.jpg" width="213" height="193" /></td>
          <td colspan="2">&nbsp;</td>
        </tr>
        <tr>
